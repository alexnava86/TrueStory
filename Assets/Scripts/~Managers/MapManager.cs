...
public class MapManager : MonoBehaviour
{
    ...
    public void ReadMap()
    {
        ...
        if (mapFile != null)
        {
            ...
            {
                if (json["layers"][layer]["name"].ToString().Trim('"') == "Collider")
                {
                    tilemaps.Add(CreateTilemap(json["layers"][layer]["name"].ToString().Trim('"'), 0.5f, 0.5f, 0.1f));
                    ...
                    tilemaps[layer].gameObject.GetComponent<CompositeCollider2D>().vertexDistance = 4f;
                    tilemaps[layer].gameObject.GetComponent<CompositeCollider2D>().edgeRadius = 4f;
                ...
                {
                    string path = json["tilesets"][layer]["image"].ToString().Trim('"').Remove(0, 3); //Removes the "../" at the beginning of path...
                    ...
                    List<Tile> tiles = tileset.ToList<Tile>();
                    ...
                    for (int i = 0; i < width * height; i++)
                    {
                        ...
                        if (tileID != 0)
                        {
                            tileIDOffset = json["tilesets"][layer]["firstgid"].AsInt;
                            y = i / width;
                            x = i % width;
